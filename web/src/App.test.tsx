...
describe('TT27 onboarding', () => {
  ...
  it('uses the complete Burmese verdict and position narrative in Best Days', () => {
    ...
    expect(screen.getByText(/ဓနသိဒ္ဓိနက္ခတ် ကောင်းကျိုးရစေသော ဒါနယတြာ/)).toBeInTheDocument()
    expect(screen.getByText(/လင်မယားစုံတွဲကို ဧည့်ခံကျွေးမွေးခြင်း/)).toBeInTheDocument()
